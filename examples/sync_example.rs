...
use gateio_rs::api::spot::{amend_order, cancel_order, create_order, get_account, get_currency_pair, get_currency_pairs, get_ticker};
...
fn main() -> Result<(), Box<gateio_rs::ureq::Error>> {
    ...
    // let req = create_order("DUREV_USDT", "buy", "700").price("0.004324");
    ...
    // let req = amend_order("862898294020", "DUREV_USDT").price("0.004325");
